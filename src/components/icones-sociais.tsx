...
// Fase 58 — mesma política dos irmãos acima: glifo genérico (nota
// musical, que é o que a plataforma evoca), nunca uma cópia do logotipo
// oficial. Chega junto com o campo `tiktok`, a única rede que faltava no
// conjunto institucional.
export function IconeTiktok({ className }: IconeProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className={className}>
      <circle cx="8" cy="17" r="3.2" />
      <path d="M11.2 17V4.5c1 2 2.6 3.2 4.8 3.4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
